...
exports.fetchSolanaPrice = async () => {
  try {
...
exports.fetchTrendingCoins = async () => {
  try {
...
exports.fetchCoinDetails = async (coinId) => {
  try {
...
exports.fetchCoinMarketChart = async (coinId, days = 7) => {
  try {
